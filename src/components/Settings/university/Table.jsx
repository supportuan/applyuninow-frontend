    ...
    >
          ...
          {data.map((item) => (
            ...
            >
              ...
              <TableCell align="center" sx={{ fontSize: "0.8rem", maxWidth:150,   overflow: "hidden", textOverflow: "ellipsis", }}>
                <div className="audio flex justify-center items-center  gap-4">
                  {item?.logo && (
              ...
              <TableCell align="center" sx={{ fontSize: "0.8rem" }}>
                <p className="audio"> {item?.city ? item?.city : "--"}</p>
              </TableCell>
      ...
      {open.archeiveLargeScreen ? (
        <DeleteModal
          ...
          type="archeive"
          title=" Are you sure you want to Archive the University?"
          loading={loading}
