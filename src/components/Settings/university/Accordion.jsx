            ...
            >
              ...
              >
                <Typography>
                  <div className="text-white flex gap-4  items-center">
                    <div>
                      {/* <div className="w-8 h-8 bg-lightblue rounded-full"></div> */}
                      <img src={item?.flag} alt="flag" className="w-10 rounded-full" />
                    </div>
                    <div>
                      <p className="text-white audio text-xs">
                        {item?.name}
                      </p>
                      <p className="text-white audio text-xs opacity-50">
              ...
              <AccordionDetails>
                <Typography>
                  <div className="flex flex-col gap-6">
                    <div className="bg-[#151929] rounded-lg p-4 flex flex-col gap-6">
...

                      {
                        ...
                        <img src={item.logo} alt="flag" className="w-12" />
                      </div>
                      }
                      ...
                      <div className="w-full grid grid-cols-2">
                        <p className="opacity-50 text-xs text-white audio break-all">
                          Location/State :
                        </p>
                        <p className="text-xs text-white audio">
                          {item?.location ? item?.location : "--"}
                  ...
                  <Link to={`/settings/universities/edit/${item.id}`}>
                        <Tooltip title="edit">
                          <svg
                            width="23"
                            height="23"
                  ...
                  <Link to={`/settings/universities/edit/${encryptData(item?.id)}`}>
                    <Tooltip title="edit">
                      <svg
                        width="23"
                        height="23"
