...
export const StaffListingTable = () => {
  ...
  const getUsers = (inputs, page) => {
    ...
    api
      .get(
        ...
        }&search_key=${inputs.search_key.trim()}&page=${page}&user_type=1`
      )
      .then((res) => {
        // console.log(res);
        setLoading(false);
  ...
  const createRoute = () => {
    navigate("/users/internal/create-staff");
  };
  ...
  return (
    <div >
      <div className="flex flex-col gap-4 md:gap-0 lg:flex-row lg:justify-between ">
        ...
        <div className="w-full flex gap-4 justify-end">
          ...
          <CustomButton
            ...
            borderRadius="8px"
          >
            <p className="text-xs sm:text-sm hidden md:block">New Internal Staff</p>
      ...
      {loading ? (
        ...
        <p className="text-[10px] lg:text-[12px] mb-2 audio mt-2  ml-2">
          Showing{" "}
