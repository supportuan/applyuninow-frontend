...
const StaffView = () => {
  ...
  console.log(usersData.offer_letter, "offer");
  ...
  const userDetails = [
    ...
    },
    {
      ...
      value: `${
        usersData?.emg_contact_phone
          ? `+91 ${usersData?.emg_contact_phone}`
          : "--"
      }`,
    },
  ];
  ...
  const handleEdit = () => {
    navigate(`/users/internal/edit-staff/${id}`);
  };
  ...
  return (
    <div className="p-2 lg:p-4 mb-10 text-white ">
      <p className="text-xs ml-2">
        ...
        {">"}
        <span className="ml-2">View Internal Staffs</span>
      </p>
      <p className="font-bold  text-2xl ml-2 mb-4">View Internal Staff</p>
          ...
          <div className="flex bg-light rounded-lg flex-col w-full gap-5 ">
            <Tab
              ...
              data={[
                ...
                <Payslips usersData={usersData} getUsersData={getUsersData} />,
              ]}
            />
          </div>
        </div>
