...
import BasicTable from "./ExternalTable";
...
const ExternalResourcesListing = () => {
  ...
  const getResourcesList = (inputs) => {
    ...
    api
      .get(
        `${BASE_URL}/admin/resources?type=2&page=${inputs.page}&search_key=${inputs.search_key}`
      )
      .then((res) => {
        setLoading(false);
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedId) {
      ...
      api
        .post(`${BASE_URL}/admin/resources?type=2`, formData)
        .then((response) => {
          let resources = [...resourcesList];
          resources.unshift(response.data.data);
          setResourcesList(resources);
          ...
          <>
            ...
            <div>
              ...
              {resourcesList.length > 0 ? (
                ...
                <div className="hidden lg:flex justify-center mt-56">
                  <p>Not Found!!!!</p>
                </div>
              )}
            </div>
            <div>
              ...
              {resourcesList.length > 0 ? (
                ...
                <div className="flex lg:hidden justify-center mt-56">
                  <p>Not Found!!!!</p>
                </div>
              )}
            </div>
...
export default ExternalResourcesListing;
