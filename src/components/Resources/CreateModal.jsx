...
const Modal = ({ open, handleClose, params, formErrors, handleChange, handleImage, handleSubmit, deleteFile, isLoading, selectedId }) => {
  return (
      ...
      >
        ...
        >
          <div className="flex justify-between audio text-white">
            {selectedId ? 'Update Folder' : '+ Folder'}
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            <DialogContentText id="alert-dialog-description">
              <div className=" w-full bg-tab text-white p-2 py-3 lg:p-4 rounded-lg flex flex-col gap-6">
                <Input
                  disabled={false}
                  readOnly={false}
                  name="name"
                ...
                <FileUpload
                  ...
                  id="folder"
                  maxSize={5}
                  imageUrl={params.folder_image}
                  filename="folder_image"
                  error={formErrors.folder_image}
                />
              </div>
            </DialogContentText>
          </DialogContent>
