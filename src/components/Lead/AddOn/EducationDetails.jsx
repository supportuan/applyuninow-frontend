  ...
  return (
    <div className="w-full rounded flex flex-col gap-6">
      ...
      >
        ...
        >
          <Typography>
            <p className="audio my-2 mx-3 text-white">Education Background</p>
          </Typography>
        </AccordionSummary>
        ...
        <AccordionDetails className={classes.details}>
          <div className="flex flex-col gap-6">
            <div className="bg-[#151929] rounded-lg p-4">
              ...
              <div className="mt-4 flex flex-col gap-4 lg:grid lg:grid-cols-4">
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Year of Completion</p>
                  <p className="text-white">2022</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Enter Your %</p>
                  <p className="text-white">89%</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Medium</p>
            ...
            <div className="bg-[#151929] rounded-lg p-4">
              <p className="audio text-white mb-1">
                Higher Secondary School cerificate/10th
              </p>
              <hr />
              <div className="mt-4 flex flex-col gap-4 lg:grid lg:grid-cols-4">
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
            ...
            <div className="bg-[#151929] rounded-lg p-4">
              ...
              <div className="mt-4 flex flex-col gap-4 lg:grid lg:grid-cols-4">
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Type of Degree</p>
                  <p className="text-white">2022</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Start Year/End Year</p>
                  <p className="text-white">89%</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">CGPA</p>
                  <p className="text-white">English</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">BackLogs</p>
      ...
      >
        ...
        >
          <Typography>
            <p className=" audio my-2 mx-3 text-white">Test Results</p>
          </Typography>
        </AccordionSummary>
        ...
        <AccordionDetails className={classes.details}>
          <div className="flex flex-col gap-6">
            <div className="bg-[#151929] rounded-lg p-4">
              <p className="audio text-white mb-1">GRE</p>
              <hr />
              <div className="mt-4 flex flex-col gap-4 lg:grid lg:grid-cols-4">
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Overall Score</p>
                  <p className="text-white">158</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Verbal</p>
                  <p className="text-white">89</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Quants</p>
                  <p className="text-white">25</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Analytical Writing Analysis</p>
                  <p className="text-white">4</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#151929] rounded-lg p-4">
              ...
              <div className="mt-4 flex flex-col gap-4 lg:grid lg:grid-cols-4">
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Read</p>
                  <p className="text-white">2022</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Write</p>
                  <p className="text-white">89%</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Listen</p>
                  <p className="text-white">English</p>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
                  <p className="text-[#61617E]">Speak</p>
                  <p className="text-white">4</p>
                </div>
              </div>
            </div>
