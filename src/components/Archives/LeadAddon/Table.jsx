          ...
          <TableRow>
            {cols.map((header, index) => (
              <TableCell
                key={index}
                align="center"
                sx={{ color: "#6A6A78", fontSize: "12px", lineHeight: '18px' }}
              >
        ...
        <TableBody>
          {data.map((item, index) => (
            ...
            >
              ...
              <TableCell align="center" sx={{ fontSize: "0.8rem", padding: '10px' }}>
                <p className="audio">{item?.first_name}{" "}{item?.last_name}</p>
              </TableCell>
              <TableCell align="center" sx={{ fontSize: "0.8rem", padding: '10px' }}>
                <p className="audio">
              ...
              <TableCell align="center" sx={{ fontSize: "0.8rem", padding: '10px', maxWidth: '130px' }}>
                {
                  item?.selected_service ?
                    item?.selected_service.split(',').map((x, i) =>
                      <p key={i} className="audio">{x}</p>
                    ) :
                    "--"
