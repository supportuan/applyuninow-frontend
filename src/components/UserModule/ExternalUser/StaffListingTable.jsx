...
export const StaffListingTable = () => {
  ...
  const getUsers = (inputs, page) => {
    ...
    api
      .get(
        `${BASE_URL}/admin/users?role_id=${inputs.role_id}&document_status=${
          inputs.document_status
        }&search_key=${inputs.search_key.trim()}&page=${page}&user_type=2`
      )
      .then((res) => {
        setLoading(false);
  ...
  const createRoute = () => {
    navigate("/users/external/create-staff");
  };

  return (
    <>
      <div className="flex flex-col gap-4 md:gap-0 lg:flex-row lg:justify-between ">
        <div className="w-full">
          <h1 className=" audio text-white text-[16px] md:text-2xl">
            External Staffs Listing
          </h1>
        </div>
        ...
        <div className="w-full flex gap-4 justify-end">
          ...
          <CustomButton
            ...
            icon={
              ...
              >
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M11.1237 1.33594H4.87611C2.69833 1.33594 1.33325 2.87733 1.33325 5.05938V10.9458C1.33325 13.1279 2.69198 14.6693 4.87611 14.6693H11.1237C13.3079 14.6693 14.6666 13.1279 14.6666 10.9458V5.05938C14.6666 2.87733 13.3079 1.33594 11.1237 1.33594Z"
                  stroke="#151929"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            borderRadius="8px"
          >
            <p className="text-xs sm:text-sm hidden md:block">New External Staff</p>
            <p className="text-xs sm:text-sm block md:hidden">New Staff</p>
      ...
      {loading ? (
        ...
        <p className="text-[10px] lg:text-[12px] mb-2 audio mt-4  ml-2">
          Showing{" "}
      ...
      {loading ? (
        <div className="w-full">
          <p className="text-center audio text-3xl mt-2">Loading....</p>
        </div>
      ) : (
