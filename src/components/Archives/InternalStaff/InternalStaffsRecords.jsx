...
const InternalStaffsRecords = () => {
  ...
  const getUsers = (inputs, page) => {
    ...
    api
      .get(
        `${BASE_URL}/admin/archives/users?role_id=${inputs.role_id}&document_status=${inputs.document_status}&search_key=${inputs.search_key}&page=${page}&user_type=1`
      )
      .then((res) => {
        // console.log(res);
        setLoading(false);
...
export default InternalStaffsRecords;
