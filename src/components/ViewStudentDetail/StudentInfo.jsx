  ...
  return (
    <div className="w-full rounded flex flex-col gap-6">
      ...
      >
        ...
        >
          <Typography>
            <p className="audio my-2 mx-2 text-yellow">Student info</p>
          </Typography>
        </AccordionSummary>
        ...
        <div className="inner-div mt-4 flex flex-col gap-4 lg:grid grid-cols-4 lg:gap-10">
            <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
              <p className="text-secondary text-xs">Student Id</p>
              <p className="flex justify-start text-sm md:text-base break-all text-white">{Student?.student?.id || "--"}</p>
            </div>
            <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
              <p className="text-secondary text-xs">Lead Id</p>
              <p className="flex justify-start text-sm md:text-base break-all text-white">
                {Student?.student?.lead_id || "--"}
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
            ...
            <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
              <p className="text-secondary text-sm md:text-base">Phone Number</p>
              {Student?.student?.phone ? (
                <>
                  <p className="text-sm md:text-base break-all text-white">+91 {Student?.student?.phone}</p>
                </>
              ) : (
                "--"
              )}
            ...
            <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
              ...
              <p className="break-all text-sm md:text-base text-white">{Student?.student?.email || "--"}</p>
            </div>
            <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
              <p className="text-secondary text-xs ">Application Created On</p>
              {Student?.student?.created_at ? (
                <>
                  <p className="text-sm md:text-base break-all text-white">
                    {moment(Student?.student?.created_at).format("DD/MM/YYYY")}
                    <br />
                    {moment(Student?.student?.created_at).format("LT")}
                  </p>
                </>
              ) : (
                "--"
            ...
            <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col  lg:gap-1 ">
              ...
              <p className="text-sm md:text-base break-all text-white "> {Student.student?.primaryContact?.name || '--'}</p>
            </div>
          </div>
        </AccordionDetails>
      </Accordion>
