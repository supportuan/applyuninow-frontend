  ...
  const update = (payload) => {
    ...
    api
      ...
      .then((res) => {
        ...
        navigate(`/users/external/view/${id}`);
      })
      .catch((error) => {
        setLoading(false);
  ...
  return (
    <div className="p-2 lg:p-6 text-white">
      <p className="text-xs">
        ...
        {">"}
        <Link
          to={`/users/external/view/${id}`}
          className="ml-2 mr-1 cursor-pointer"
        >
          View External Staff
        </Link>{" "}
        {">"}
        <span className="ml-2">Edit External Staff</span>
      </p>
      <p className="text-2xl font-semibold mb-4">Edit External Staff</p>
