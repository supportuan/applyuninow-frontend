...
import refresh from "../assets/allstudents/refresh.svg";
...
const StudentExplore = () => {
  ...
  const getMetaList = () => {
    axios
      ...
      .then((res) => {
        ...
        res.data.data.study_durations = study_durations;
        res.data.data.type_of_degree = type_of_degree;
        res.data.data.study_level = study_level;
        res.data.data.study_industry = study_industry;
  ...
  const getStudyArea = (industry_id, id) => {
    ...
    axios
      .get(
        `${environment.API_BASE_URL}/study-areas?industry_id=${industry_id}&sub_industry_id=${id}&search_key=${studySearch}`
      )
      .then((res) => {
  ...
  return (
    <>
      <div className="App">
        ...
        <Header />
        <section className="additional-services relative explore-service">
          <div className="container bg-transarent">
                    ...
                    <div className="vertical-tab-header">
                      <div className="vertical-tab-header-content">
                        <div className="w-full">
                          <h4 className="text-sm md:text-2xl my-2 ">
                            I am interested in...
                          </h4>
                        </div>
                      </div>
                      ...
                      >
                        {meta.study_destination.map((x, i) => (
                          <div
                            ...
                            key={uuid()}
                            className={`student-contry-list study_destination relative cursor-pointer space-y-2 ${x.checked ? "bg-lightRed" : ""
                              }`}
                          >
                            <div className="m-4">
                              <div>
                  ...
                  <div className="vertical-tab-sec-col">
                    <div className="vertical-tab-header">
                      <div className="vertical-tab-header-content">
                        <div className="flex  w-full items-center justify-center">
                          <div className="w-full flex explore-actions  justify-between  px-0 md:px-10 items-center">
                            <img src={backwardArrow} className="block cursor-pointer" alt="" onClick={() => setStep(1)} />
                            <h4 >
                              Choose the study level

                            </h4>

                            <img src={forwardArrow} alt="" className="block cursor-pointer" onClick={() => {
                              studyNext();
                            }} />
                    ...
                    <div className="vertical-tab-content-section w-full">
                      <div className="card-view ">
                        <div className="study-level mt-4 lg:mt-2">
                    ...
                    <div className="vertical-tab-content-section w-full">
                      <div className="card-view margin-bottom-sm">
                        <div className="study-level mt-4">
                          <ul
                      ...
                      <div className="vertical-tab-header-content">
                        <div className="flex  w-full items-center justify-center">
                          <div className="w-full flex  justify-between explore-actions  px-0 md:px-10 items-center">
                            <img src={backwardArrow} className="block  cursor-pointer" alt="" onClick={() => setStep(2)} />
                            <h4 >
                    ...
                    <div className="vertical-tab-content-section w-full">
                      <div className="card-view">
                        <div className="study-level">
                          <div className="flex flex-col md:flex-row gap-2 mt-2 py-4 px-3 md:px-10">
                            <div className="w-full ">
                              <SelectInput
                  ...
                  <div className="vertical-tab-sec-col">
                    <div className="vertical-tab-header">
                      <div className="vertical-tab-header-content">
                        <div className="flex  w-full items-center justify-center">
                          <div className="w-full flex  justify-between explore-actions  px-0 md:px-10 items-center">
                            <img src={backwardArrow} className="block cursor-pointer" alt="" onClick={() => setStep(3)} />
                            <h4 >
                              Discover your subject and experience your passion
                            </h4>
                            <img src={forwardArrow} alt="" className="block cursor-pointer" onClick={industryNext} />
                    ...
                    <div className="vertical-tab-content-section study_industry-sec">
                      <div className="card-view grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap:0 space-x-2 md:space-x-0 justify-center md:ml-16 ">
                        {meta?.study_industry?.map((x) => (
                          ...
                          >
                            ...
                            />
                            <p
                              className={`mt-2 md:mt-12 p-2 md:p-4 break ${x.checked ? "text-white" : "text-[#1e417c]"
                                }`}
                            >
                              {x.name}
                            </p>
                        ...
                        {meta.study_industry && !meta.study_industry.length && (
                          <div className="text-center col-span-2 md:col-span-4 py-4">
                  ...
                  <div className="vertical-tab-sec-col">
                    <div className="vertical-tab-header">
                      <div className="vertical-tab-header-content">
                        <div className="flex  w-full items-center justify-center">
                          <div className="w-full flex  justify-between explore-actions  px-0 md:px-10 items-center">
                            <img src={backwardArrow} className="block cursor-pointer" alt="" onClick={() => setStep(4)} />
                            <h4>
                              Discover more...
                            </h4>
                  ...
                  <div className="vertical-tab-sec-col ">
                    <div className="vertical-tab-header">
                      <div className="vertical-tab-header-content">
                        <div className="flex  w-full items-center justify-center">
                          <div className="w-full flex  justify-between explore-actions  px-0 md:px-10 items-center">
                            <img src={backwardArrow} className="block cursor-pointer" alt="" onClick={() => setStep(5)} />
                            <h4 >
                              Choose the subject area
                            </h4>
                            <img src={forwardArrow} alt="" className="block cursor-pointer" onClick={onLevelSelect} />
                    ...
                    <div className="vertical-tab-content-section">
                      <div className="card-view">
                        <div className="choose-study-area">
                          <div className="w-full pb-0 p-2 md:px-16">
                            <SearchBar
                              placeholder="Search"
                              handleChange={(e) => handleStudySearch(e)}
                              value={studySearch}
                              name="search_key"
                              width={undefined}
                              label="hello"
                          ...
                          <div className="study-level study-level-sec mt-0 md:mt-4 mx-4 md:mx-14">
                            <ul>
                  ...
                  <div className="vertical-tab-sec-col">
                    <div className="vertical-tab-header">
                      <div className="vertical-tab-header-content">
                        <div className="flex  w-full items-center justify-center">
                          <div className="w-full flex  justify-between explore-actions  px-0 md:px-10 items-center">
                            <img src={backwardArrow} className="block cursor-pointer" alt="" onClick={() => backScience()} />
                            <h3 >
                              Help us to understand better
                            </h3>
                            <img src={forwardArrow} alt="" className="block cursor-pointer" onClick={() => onExtraDetailsStep()} />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="vertical-tab-content-section">
                      <div className="card-view  px-1 md:px-8">
                  ...
                  <div className="vertical-tab-sec-col">
                    <div className="vertical-tab-header">
                      <div className="vertical-tab-header-content">
                        <div className="flex  w-full items-center justify-center">
                          <div className="w-full flex  justify-between explore-actions px-0 md:px-10  items-center">
                            <img src={backwardArrow} className="block cursor-pointer" alt="" onClick={() => setStep(7)} />
                            <h3 >
                              Please provide your academics
                            </h3>
                            <img src={forwardArrow} alt="" className="block cursor-pointer" onClick={() => onEducationDetails()} />
                          </div>
                        </div>
                      </div>
                    </div>

                    <div className=" px-2 lg:px-16 mt-2 md:mt-4">
                      <h5 className="w-full text-sm md:text-[16px] text-center lg:text-left text-[#C41230] ">
                        Secondary school Certificate / 10th
                      </h5>
                      <div className="w-full flex-col lg:flex-row flex gap-6 mt-3">
                        <div className="flex lg:hidden justify-center w-full gap-1">
                          <div className="w-1/2 lg:w-[30%] mui-date-picker">
                            <Input
                              disabled={false}
                              readOnly={false}
                        ...
                        <div className="hidden lg:block w-1/2 lg:w-[20%] mui-date-picker">
                          <Input
                            disabled={false}
                            readOnly={false}
                            name="ssc_passing_year"
                        ...
                        <div className=" hidden lg:block w-1/2 lg:w-[40%]">
                          <Input
                            disabled={false}
                            readOnly={false}
                            name="ssc_grade"
                    ...
                    <div className="px-2 lg:px-16 mt-4 ">
                      <h5 className="w-full text-center  text-sm md:text-[16px] lg:text-left text-[#C41230]">
                      ...
                      <div className="w-full flex-col lg:flex-row flex gap-6 mt-3">
                        ...
                        <div className="w-full hidden lg:block  lg:w-[20%] mui-date-picker">
                          <Input
                            disabled={false}
                            readOnly={false}
                            name="hsc_passing_year"
                    ...
                    <div className="px-2 lg:px-16 mt-4">
                      ...
                      <div className={`mb-4  ${toogleState.ug_toggle ? 'block' : 'hidden'}`}>
                        <div className="w-full gap-2 grid grid-cols-1 lg:grid-cols-2 md:gap-6 pb-2">
                          <div className="w-full">
                            <SelectInput
                              options={[
                                {
                        ...
                        <div className="w-full  gap-2 grid grid-cols-2 lg:grid-cols-3 md:gap-4">
                    ...
                    <div className="px-2 lg:px-16 mt-4 pb-6">
                      ...
                      <div className={`${toogleState.pg_toggle ? 'block' : 'hidden'}`}>
                        <div className="w-full gap-2 grid grid-cols-1 lg:grid-cols-2 md:gap-6 pb-4">
                          <div className="w-full">
                            <SelectInput
                              options={[
                                {
                  ...
                  <div className="vertical-tab-sec-col">
                    <div className="vertical-tab-header">
                      <div className="vertical-tab-header-content">
                        <div className="flex  w-full items-center justify-center">
                          <div className="w-full flex  justify-between explore-actions  px-0 md:px-10 items-center">
                            <img src={backwardArrow} className="block cursor-pointer" alt="" onClick={() => setStep(8)} />
                            <h4>
                              Additional Assessments...
                            </h4>
                            <img src={forwardArrow} alt="" className="block cursor-pointer" onClick={() => onTest()} />
                          </div>
                        </div>
                      </div>

                      <div className="flex flex-col p-2 w-full gap-4 px-6 mt-4 md:mt-16 ">
                        ...
                        <div
                          className={`lg:mx-60 ${!examParams.eng_prof_test ||
              ...
              {step == 10 ? (
                <>
                  <div className="vertical-tab-sec-col">
                    <div className="vertical-tab-header">
                      <div className="vertical-tab-header-content">
                        <div className="flex  flex-col w-full items-center justify-center">
                          <div className="w-full flex  justify-between explore-actions  px-0 md:px-10  items-center">
                            <img src={backwardArrow} className="block cursor-pointer" alt="" onClick={() => setStep(9)} />
                      ...
                      <div className="mx-0 md:mx-4 px-4 md:px-8  pt-2 md:pt-0 submit-form hidden md:block">
                        <p className="text-center text-xs md:text-base text-[#C22032] pb-1 md:pb-0 ">
                          Create your free account and have the best experience of
                        </p>
                        <p className="text-center text-xs md:text-base text-[#1E417C] pb-2 md:pb-0 ">
                          100% digital & 100% transparent Upskilling!*
                        </p>
                      </div>
                      <div className="mx-0 md:mx-4 px-4 md:px-8 pt-2 md:pt-0 submit-form block md:hidden">
                        <p className="text-center text-xs md:text-base text-[#C22032] ">
                    ...
                    <div className="vertical-tab-content-section px-4 md:px-8">
                      <div className="card-view">
                        <div className="sm:grid-cols-2 grid-cols-1 grid gap-4 px-0 md:px-4 md:mt-8 pb-4">
                          <div>
                            <Input
                              disabled={false}
                              readOnly={false}
                        ...
                        <div className="flex flex-col justify-between mt-5 w-full">
                          <div className="flex  flex-col justify-start gap-2 submit-form-text">
                            <div className="flex">
                              <CustomCheckbox
                              ...
                              <p className="mt-2 text-sm">
                                I consent to receive Communications from ApplyUniNow. Any data collected with be processed in accordance with our{" "}
                            ...
                            <p className="text-[#1e417c] text-xs md:text-sm  pl-10 md:pl-12 text-left small-txt">
                              **if you are minor in your jurisdiction of
                              residency, you must have your parents / guardian
                        ...
                        <div className="flex justify-center md:justify-end pb-4 pr-0 md:pr-4">
                          {loading ? (
                ...
                <>
                  <div className="vertical-tab-sec-col">
                    <div className="vertical-tab-header">
                      ...
                      <div className="m-1 md:m-4 ml-4 submit-form">
                        <p className=" text-lg md:text-xl">
                          Please wait momentarily
                        </p>

                      </div>
                      <div className="m-1 md:m-4 ml-4 submit-form pb-4 hidden  md:block">
                        <p className="text-[#C22032]  text-sm md:text-base">
                          While ApplyUniNow expert - your
                          study abroad partner will contact you at the earliest possible.
                        </p>
                      </div>
                      <div className="m-1 md:m-4 ml-4 submit-form pb-2 md:pb-4 block  md:hidden">
                        <p className="text-[#C22032]  text-sm md:text-base">
                          While ApplyUniNow expert
                        </p>
                        <p className="text-[#C22032]  text-sm md:text-base">
                          your study abroad partner will contact you
                        </p>
                        <p className="text-[#C22032]  text-sm md:text-base">
                      ...
                      <div className="m-2 md:m-4 ml-4 submit-form pb-1 md:pb-4 hidden  md:block">
                        <p className="text-[#1e417c]  text-base md:text-lg">
                          We’re technology guided with
                          100% digital & 100% transparency
                          with the real time updates and
                          allowing you to be more confident
                          with ongoing and onward journey.
                        </p>
                      </div>

                      <div className="m-1 md:m-4 ml-4 submit-form pb-1 md:pb-4 block  md:hidden">
                        <p className="text-[#1e417c]  text-base md:text-lg">
                          We’re technology guided
                        </p>
                        <p className="text-[#1e417c]  text-base md:text-lg">
                          with 100% digital & 100% transparency
                        </p>
                        <p className="text-[#1e417c]  text-base md:text-lg">
                          with the real time updates and
                          allowing
                    ...
                    <div className="flex flex-col justify-center items-center m-1 md:m-4 text-[#1e417c] ">
                      <img width={150} onClick={() => navigate("/")} src={logo} />
                      <p className="text-center cursor-pointer text-xs md:text-sm  text-[#C22032] pb-2" onClick={() => navigate("/")}>Click here to homepage</p>

                      <p className="flex-grow text-sm md:text-base"> Admission counselling</p>
                      <p className="flex-grow text-sm md:text-base">University selection</p>
                      <p className="flex-grow text-sm md:text-base"> Application Assistance</p>
                      <p className="flex-grow text-sm md:text-base"> Pre-Departure</p>
                      <p className="flex-grow text-sm md:text-base">Travel assistance</p>
                      <p className="flex-grow text-sm md:text-base">ON-Arrival assistance *</p>
                      <p className="flex-grow text-sm md:text-base">Internship assistance *</p>
                      <p className="flex-grow text-sm md:text-base">Professional placement assistance *</p>
